...
public class Database extends SQLiteOpenHelper  {
    ...
    public static final String DATABASE_NAME = "MyBMI.db";
    ...
    public static final String COL_7 = "VALUE";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table "+ TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,GENDER TEXT,DATE INT,WEIGHT FLOAT,HIGHT FLOAT,ANSWER CHAR,VALUE FLOAT  )");
    ...
    public boolean inserData(String Gender,String date, String weight ,String hight,String answer,String value){
