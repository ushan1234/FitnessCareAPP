...
public class AddReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(AddReport.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(AddReport.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Gender));
        ...
        mDisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        AddReport.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListener, year, month, day
                );
    ...
    private void addHealth(){
        ...
        if(!TextUtils.isEmpty(Pressure)){
            ...
            CalHelper addHealth=new CalHelper(id,Blood,Gender,Pressure,Sugar,Cholesterol,Date);
